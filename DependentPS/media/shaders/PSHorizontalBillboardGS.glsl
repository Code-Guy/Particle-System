...
void main()
{
	...
	vec4 v0 = vec4(center + vec3(-1, 0, 1) * G_Size_Angle_TimeRatio[0].x, 1.0);	//1象限
    vec4 v1 = vec4(center + vec3(1, 0, 1) * G_Size_Angle_TimeRatio[0].x, 1.0);//2象限
    vec4 v2 = vec4(center + vec3(1, 0, -1) * G_Size_Angle_TimeRatio[0].x, 1.0);//3象限
   	vec4 v3 = vec4(center + vec3(-1, 0, -1) * G_Size_Angle_TimeRatio[0].x, 1.0);//4象限
